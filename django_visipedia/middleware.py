...
class VisipediaMiddleware(object):
	...
	def process_request(self, request):
		assert hasattr(request, 'session'), "The Visipedia authentication middleware requires session middleware to be installed. Edit your MIDDLEWARE_CLASSES setting to insert 'django.contrib.sessions.middleware.SessionMiddleware'."
